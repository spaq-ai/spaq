...
import { Brain, Mail, Lock, ArrowRight, Eye, EyeOff, User, Building2, Sparkles, Shield, Users, Zap } from 'lucide-react'
...
export default function RegisterPage() {
  ...
  const features = [
    { icon: <Brain className="w-5 h-5" />, title: "AI-Powered Insights", description: "Custom AI trained on your decisions" },
    { icon: <Shield className="w-5 h-5" />, title: "Enterprise Security", description: "SOC 2 compliant infrastructure" },
    { icon: <Users className="w-5 h-5" />, title: "Team Collaboration", description: "Built for modern teams" },
    { icon: <Zap className="w-5 h-5" />, title: "Real-time Updates", description: "Live decision tracking" },
  ]
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float animation-delay-200"></div>
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float animation-delay-300"></div>
      </div>

      <div className="relative z-10 w-full max-w-6xl flex gap-12">
        {/* Left side - Features */}
        <motion.div
        ...
        >
          ...
          <p className="text-xl text-gray-400 mb-12">
            Join thousands of teams building decision intelligence
          </p>
          ...
          <div className="grid grid-cols-2 gap-6">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-800 p-6 rounded-xl">
        ...
        >
            ...
            {[1, 2].map((step) => (
              <div
                ...
                className={cn(
                  ...
                  currentStep >= step ? "bg-purple-500" : "bg-gray-800"
                )}
              />
            ))}
          </div>
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      {errors.organizationName && (
                        <motion.p
                          ...
                          className="text-sm text-red-400 flex items-center gap-1"
                        >
                          <span className="text-xs">⚠</span> {errors.organizationName.message}
                        </motion.p>
                      )}
                    </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {teamSizeOptions.map((option) => (
                          ...
                          >
                            ...
                            />
                            <div className={cn(
                              "relative px-4 py-3 bg-black/50 border rounded-lg text-center",
                              "transition-all duration-300",
                              ...
                              <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-purple-500/20 to-pink-500/20 opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none" />
                            </div>
                          </label>
                        ))}
                      </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        className="px-6 py-3 bg-neutral-900 border border-neutral-800 rounded-lg hover:bg-neutral-800 transition"
                      >
                        Back
                      </button>
                      ...
                      <Button
                        borderRadius="0.75rem"
                        className="bg-black text-white border-neutral-800 flex-1 h-12 font-medium"
                        borderClassName="bg-[radial-gradient(var(--purple-500)_40%,transparent_60%)]"
                        type="submit"
                        disabled={isLoading}
                      >
          ...
          >
            <p className="text-gray-400">
              ...
              <Link href="/login" className="text-purple-400 hover:text-purple-300 font-medium transition group">
